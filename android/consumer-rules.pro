...
# dereferences it -> fatal NPE on any checkPermissions() call. This plugin does
# nothing but permissions, so that NPE is the whole plugin failing.
...
-keepclassmembers class com.jmricardo.plugin.AudioPermissionsPlugin {
